<h2 class="h4 mb-4">Hồ sơ quản trị viên</h2>
<div class="card bg-primary bg-opacity-75 text-light mb-5">
    <div class="card-body d-flex flex-column flex-md-row align-items-start">
        <div class="me-md-4 mb-3 mb-md-0">
            <div class="bg-dark rounded-circle d-flex align-items-center justify-content-center" style="width:100px;height:100px;color:#ffc107;font-size:2rem;">
                <i class="bi bi-person-circle"></i>
            </div>
        </div>
        <div class="flex-grow-1">
            <h5 class="mb-1 text-warning"><?= htmlspecialchars($user['account_name'] ?? $user['email']) ?></h5>
            <p class="text-muted mb-4 small"><?= htmlspecialchars($user['email']) ?></p>
            <form method="post" class="row g-3">
                ...
                <div class="col-12 mt-3">
                    <a href="index.php?pg=admin-profile-reset-password" class="btn btn-outline-light">Đặt lại mật khẩu</a>
                </div>
            </form>
        </div>
    </div>
